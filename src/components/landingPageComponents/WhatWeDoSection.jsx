...
export function WhatWeDoSection() {
  ...
  return (
    <section className="bg-black text-white py-16 px-4 md:py-24 data-scroll-section">
        ...
        >
          ...
          <div className="lg:hidden text-center space-y-6">
            <div className="flex items-center justify-start gap-2 mb-4">
              <div className="">
                <CirclePlus className="w-4 h-4 white" />
              </div>
              <span className="text-md font-[600] text-white">What we do</span>
            </div>

            <h2 className="text-3xl text-[#686868] font-bold leading-snug">
              Think uber <br />
              and amazon. <br />
              <span className="text-white">but for .Content</span>
            </h2>

            <div className="space-y-2 text-[#9b9a9a] text-md leading-relaxed">
              <p>
          ...
          <div className="hidden lg:grid grid-cols-12 gap-8 items-stretch">
            ...
            <div className="col-span-7 space-y-8 lg:space-y-12">
              ...
              <h2 className="text-4xl text-[#686868] md:text-5xl lg:text-6xl font-bold leading-tight">
                Think uber
                <br />
                and amazon.
                <br />
              ...
              <div className="flex flex-col lg:flex-row gap-8">
                {/* Paragraphs */}
                <div className="lg:w-[60%] space-y-4 md:space-y-4 text-[#9b9a9a] text-md md:text-base leading-relaxed">
                  <p>
